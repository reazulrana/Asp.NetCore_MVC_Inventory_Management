#pragma checksum "E:\Asp.Net Core Project\SOL_InevntoryManagement_Ver_5.0\InevntoryManagement\Views\Purchase\Create.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "2c2f029f98ab1aaa30803deec71382e714c1c8ba"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"2c2f029f98ab1aaa30803deec71382e714c1c8ba", @"/Views/Purchase/Create.cshtml")]
...
#nullable disable
            ...
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("form", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2c2f029f98ab1aaa30803deec71382e714c1c8ba11134", async() => {
                WriteLiteral("\r\n    <div class=\"card\">\r\n        <div class=\"card-header\">\r\n            <h3 class=\"card-title text-white\">Create Purchase</h3>\r\n        </div>\r\n        <div class=\"card-body\">\r\n");
                WriteLiteral("            <div class=\"row\">\r\n                <div class=\"col-md-12\">\r\n                    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("div", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2c2f029f98ab1aaa30803deec71382e714c1c8ba11722", async() => {
                }
                );
...
#nullable disable
                ...
                WriteLiteral("\r\n                </div>\r\n            </div>\r\n\r\n            ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("partial", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.SelfClosing, "2c2f029f98ab1aaa30803deec71382e714c1c8ba13473", async() => {
                }
                );
            ...
            <div class=""col-md-12 border mb-2"">
                ...
                ");
#nullable restore
#line 41 "E:\Asp.Net Core Project\SOL_InevntoryManagement_Ver_5.0\InevntoryManagement\Views\Purchase\Create.cshtml"
...
#nullable disable
            ...
            <div class=""border col-md-12 mb-2"">
                ...
                ");
#nullable restore
#line 51 "E:\Asp.Net Core Project\SOL_InevntoryManagement_Ver_5.0\InevntoryManagement\Views\Purchase\Create.cshtml"
...
#nullable disable
            ...
            <div class=""col-md-12 border mb-2"">
                ...
                ");
#nullable restore
#line 61 "E:\Asp.Net Core Project\SOL_InevntoryManagement_Ver_5.0\InevntoryManagement\Views\Purchase\Create.cshtml"
...
#nullable disable
        ...
        <div class=""card-footer"">
            <div class=""form-group"">
                ...
                ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("a", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2c2f029f98ab1aaa30803deec71382e714c1c8ba16861", async() => {
            ...
            DefineSection("Scripts", async() => {
                WriteLiteral("\r\n\r\n    ");
                __tagHelperExecutionContext = __tagHelperScopeManager.Begin("script", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "2c2f029f98ab1aaa30803deec71382e714c1c8ba20192", async() => {
                }
                );
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            function amountclass()
            {
                let _amount = {
         ");
                WriteLiteral(@"           TotalAmount: $(""#TotalAmount"").val(),
            ...
            function calculatePurchageProduct()
            {
                ...
                if ($(tr).length > 0) {
                    var amount = 0;
                    $(tr).");
                WriteLiteral(@"each(function (i, item) {
                        amount = (amount + parseInt($(this).find(""td:last"").prev().text()));
                    })
                    $(""#TotalAmount"").val(amount)
                    $(""#GrossAmount"").val(amount)
       ...
       ");
        ...
        function append_New_Row()
        {
            ...
            var p = product();
            var sl = '<td><input hidden name=""ProductId"" type=""text"" value=""' + p.ProductId + '""/>' + LastSl + '</td>';
            var Image = '<td><img src=""' + $(""#txtImage"").val() + '"" height=90 width=90 /> </td>';
            var Code = '<td>' + p.Code + '</td>';
            var Description = '<td>' + p.Description + '</td>';
            var Model = '<td>' + p.Model + '</td>';
            var Size = '<td>' + p.Size + '</td>';
            var Color = '<td>' + p.Color + ");
                WriteLiteral(@"'</td>';
            var Qty = '<td> <input hidden name=""Qty"" type=""text"" value=""' + p.Qty + '""/>' + p.Qty + '</td>';
            var PurchasePrice = '<td> <input hidden name=""Price"" type=""text"" value=""' + p.PurchasePrice + '""/>' + p.PurchasePrice + '</td>';
        ...
        $.ui.autocomplete.prototype._renderMenu = function (ul, items) {
            ...
            ul.append(""<div class='divAutocomplete' style='heig");
                WriteLiteral(@"ht:200px; overflow-y:scroll; z-index:10000'><table class='prodcutAutocomplete table table-border'><thead class='bg-secondary text-white'><tr> <th>Sl</th> <th>Code</th> <th>Description</th> <th>Category</th> <th>Model</th> <th>Size</th> <th>Color</th> </tr></thead><tbody></tbody></table></div>"");
        ...
        $.ui.autocomplete.prototype._renderItem = function (table, item) {
            ...
            return $(""<tr class='ui-menu-item' role='presentation'></tr>"")
                ...
                //item.length");
                WriteLiteral(@" == isNaN ? 1 : (item.length + 1)
        ...
        $(""#txtsearchfield"").autocomplete({
            ...
            select: function (event, ui) {
                ...
                photopath = ui.item.phot");
                WriteLiteral(@"opath == null ? ""/Projects/Images/DefaultImage/No_Image_Available.jpg"" : photopath + ui.item.photopath
                $(""#txtProductCode"").val(ui.item.code),
                    $(""#txtProductId"").val(ui.item.value),
                    $(""#txtProductDescription"").val(ui.item.description),
                    $(""#txtProductModel"").val(ui.item.model),
            ...
            //source: projects,
             source: function (request, response) {
                $.ajax({
                    url: '");
#nullable restore
#line 401 "E:\Asp.Net Core Project\SOL_InevntoryManagement_Ver_5.0\InevntoryManagement\Views\Purchase\Create.cshtml"
